          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-4">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              <button
                ...
                className="inline-flex items-center justify-center rounded-xl bg-white px-4 py-3 text-sm font-semibold text-zinc-900 disabled:opacity-50 border border-zinc-200"
              >
                Выбрать еще
              </button>
              ...
              <button
                ...
                className="inline-flex items-center justify-center rounded-xl bg-zinc-900 px-4 py-3 text-sm font-semibold text-white disabled:opacity-50"
              >
